// BASSGeneratorParameters.cs - Параметры плагина
using System;
...
{
    internal sealed class BASSGeneratorParameters : IVstPluginParameters
    {
        ...
        public BASSGeneratorParameters()
        {
            ...
            var bassNotesInfo = new VstParameterInfo
            {
                Name = "Notes",
                Label = "Кол-во нот",
            ...
            _parameters.Add(new VstParameter(bassNotesInfo));
