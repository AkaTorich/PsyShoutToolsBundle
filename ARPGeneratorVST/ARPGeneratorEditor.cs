// ARPGeneratorEditor.cs - Редактор плагина с сохранением состояния
using System;
...
{
    internal sealed class ARPGeneratorEditor : IVstPluginEditor
    {
        private ARPGeneratorForm _form;
        ...
        private static int _lastArpNotesCount = 4;
        ...
        public ARPGeneratorEditor(ARPGeneratorVstPlugin plugin)
        {
            _plugin = plugin;
        }
        ...
        private void SaveFormState()
        {
            if (_form != null && !_form.IsDisposed)
            {
                ...
                _lastArpNotesCount = _form.GetArpNotesCount();
        ...
        private void RestoreFormState()
        {
            if (_form != null && !_form.IsDisposed && _stateInitialized)
            {
                ...
                try
                {
                    ...
                    _form.SetArpNotesCount(_lastArpNotesCount);
