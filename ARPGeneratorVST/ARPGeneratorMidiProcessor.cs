// ARPGeneratorMidiProcessor.cs - MIDI процессор для воспроизведения MIDI в VST
using System;
...
{
    internal sealed class ARPGeneratorMidiProcessor : IVstMidiProcessor, IVstPluginMidiSource
    {
        private ARPGeneratorVstPlugin _plugin;
        private MidiFilePlayer _midiPlayer;
        private VstEventCollection _outputEvents;

        public ARPGeneratorMidiProcessor(ARPGeneratorVstPlugin plugin)
        {
            _plugin = plugin;
