...
{
    public partial class ARPGeneratorForm : Form
    {
        ...
        internal void SetPlugin(ARPGeneratorVstPlugin plugin)
        {
            _plugin = plugin;
        }
            ...
            var bigScalePatterns = new Dictionary<string, Dictionary<string, List<int>>>
{
    ...
    "Микротональные лады", new Dictionary<string, List<int>>
    {
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            arpNotesCount = (int)txtArpNotesCount.Value;
        ...
        public int GetArpNotesCount()
        {
            return (int)txtArpNotesCount.Value;
        }

        public void SetArpNotesCount(int value)
        {
            txtArpNotesCount.Value = value;
            OnStateChanged();
        }
        ...
        private void InitializeDragDropButton()
        {
            // Инициализируем кнопку btnPlayMidi для drag-and-drop
            btnPlayMidi.Enabled = false; // Сначала кнопка недоступна
        }
        ...
        private void btnPlayInDAW_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!string.IsNullOrEmpty(_lastGeneratedMidiPath) && File.Exists(_lastGeneratedMidiPath))
                {
                    ...
                    txtProgression.AppendText("\r\n▶ Воспроизведение начато в DAW");
                }
                else
                {
                    MessageBox.Show("Сначала сгенерируйте MIDI файл!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
        }
