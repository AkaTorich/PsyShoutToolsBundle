// ARPGeneratorParameters.cs - Параметры плагина
using System;
...
{
    internal sealed class ARPGeneratorParameters : IVstPluginParameters
    {
        ...
        public ARPGeneratorParameters()
        {
            ...
            var arpNotesInfo = new VstParameterInfo
            {
                Name = "ArpNotes",
                Label = "Кол-во нот",
            ...
            _parameters.Add(new VstParameter(arpNotesInfo));
