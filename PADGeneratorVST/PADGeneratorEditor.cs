// PADGeneratorEditor.cs - Редактор плагина с сохранением состояния
using System;
...
{
    internal sealed class PADGeneratorEditor : IVstPluginEditor
    {
        private PADGeneratorForm _form;
        ...
        private static int _lastPadNotesCount = 4;
        ...
        public PADGeneratorEditor(PADGeneratorVstPlugin plugin)
        {
            _plugin = plugin;
        }
        ...
        private void SaveFormState()
        {
            if (_form != null && !_form.IsDisposed)
            {
                ...
                _lastPadNotesCount = _form.GetPadNotesCount();
        ...
        private void RestoreFormState()
        {
            if (_form != null && !_form.IsDisposed && _stateInitialized)
            {
                ...
                try
                {
                    ...
                    _form.SetPadNotesCount(_lastPadNotesCount);
