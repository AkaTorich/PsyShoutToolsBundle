// PADGeneratorMidiProcessor.cs - MIDI процессор для воспроизведения MIDI в VST
using System;
...
{
    internal sealed class PADGeneratorMidiProcessor : IVstMidiProcessor, IVstPluginMidiSource
    {
        private PADGeneratorVstPlugin _plugin;
        private MidiFilePlayer _midiPlayer;
        private VstEventCollection _outputEvents;

        public PADGeneratorMidiProcessor(PADGeneratorVstPlugin plugin)
        {
            _plugin = plugin;
